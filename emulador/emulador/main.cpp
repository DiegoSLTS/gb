...
int main() {
	...
	//std::string romName = "Motocross Maniacs (Europe) (Rev A).gb";
	...
	//std::string romName = "Tesserae (Europe) (En,Fr,De,Es,It).gb"; // broken tiles
	//std::string romName = "Tetris (World) (Rev A).gb"; // B-type, bug counting "Drops" after winning
